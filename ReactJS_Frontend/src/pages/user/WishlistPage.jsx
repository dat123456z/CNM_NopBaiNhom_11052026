        ...
        <div className="min-h-screen bg-[#f8f9fb] flex flex-col font-sans">
            ...
            <main className="flex-1 max-w-6xl mx-auto px-6 py-10 w-full">
                ...
                {loading ? (
                    ...
                    <div className="bg-red-50 text-red-600 p-4 rounded-xl border border-red-200 text-center text-sm font-semibold">
                        {error}
                    </div>
                ) : wishlist.length === 0 ? (
                        ...
                        {wishlist.map((item) => {
                            ...
                            return (
                                <div
                                    ...
                                    className="bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 cursor-pointer flex flex-col h-full group relative"
                                >
                                    {/* Image */}
                                    <div className="aspect-square bg-gray-50 overflow-hidden relative border-b border-gray-100">
                                        ...
                                        <button
                                            ...
                                            className="absolute top-3 right-3 w-8 h-8 rounded-full bg-white/95 backdrop-blur-xs flex items-center justify-center text-red-500 hover:scale-110 active:scale-95 shadow-md transition-all duration-200 cursor-pointer"
                                    ...
                                    <div className="p-4 flex-1 flex flex-col justify-between">
                                        <div>
                                            <h3 className="font-bold text-gray-800 text-sm line-clamp-2 leading-snug group-hover:text-[#00b14f] transition-colors duration-200">
                                                {item.title}
                                            </h3>
                                            <span className="inline-block mt-2 text-[10px] font-bold uppercase tracking-wider text-gray-400 bg-gray-100 px-2.5 py-0.5 rounded-full">
                                                {item.category}
                                            </span>
                                        </div>
                                        <div className="mt-4 flex items-baseline justify-between gap-2 border-t border-gray-50 pt-3">
                                            <span className="font-extrabold text-[#00b14f] text-base">
                                                {fmt(item.price)}
                                            </span>
