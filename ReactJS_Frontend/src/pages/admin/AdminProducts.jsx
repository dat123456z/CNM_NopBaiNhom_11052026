...
const AdminProducts = ({ products, stats, onUpdateProductStatus }) => (
    <div className="space-y-6">
        <div className="flex items-start justify-between">
            <div><p className="text-2xl font-black">System Overview</p><p className="text-xs text-slate-500 mt-1">Product control, moderation, and compliance queue.</p></div>
        ...
        <AdminCard className="overflow-hidden">
            <div className="p-5 border-b border-slate-100 flex justify-between"><p className="font-black">Recent Submissions Detail</p><button className="rounded-md bg-slate-900 px-4 py-2 text-xs font-bold text-white">Export Audit Report</button></div>
