...
const AdminOrders = ({ orders, stats }) => (
    <div className="space-y-6">
        ...
        <AdminCard className="p-5">
            <div className="flex justify-between"><p className="font-black">Order Directory</p><button className="rounded-md bg-red-600 px-4 py-2 text-xs font-bold text-white">Export Orders</button></div>
